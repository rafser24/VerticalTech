      ...
      >
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-4">
            ...
            <FormField label="Stock Actual" required error={errors.stock?.message}>
              <FormInput register={register('stock')} type="number" placeholder="0" error={errors.stock} />
            </FormField>
            <FormField label="Stock Mínimo" error={errors.stock_minimo?.message}>
